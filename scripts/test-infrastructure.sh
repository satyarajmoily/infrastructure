...
run_test "AI Command Gateway .env exists" "[ -f ../ai-command-gateway/.env ]"
...
run_test "AI Command Gateway Dockerfile updated" "grep -q 'as builder' ../ai-command-gateway/Dockerfile && grep -q 'as runtime' ../ai-command-gateway/Dockerfile"
...
run_test "AI Command Gateway source mount" "grep -q '../ai-command-gateway/src:/app/src:ro' docker-compose.yml"
